...
import { ApiBadRequestResponse, ApiCreatedResponse, ApiInternalServerErrorResponse, ApiOperation } from '@nestjs/swagger';
...
export class AnswerController {
    ...
    async create(@Body() createAnswerDto: CreateSurveyAnswerDto): Promise<CreateAnswerResponseDto> {
        try {
